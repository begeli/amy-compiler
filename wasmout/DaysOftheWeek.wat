(module 
  ...
  (func $DaysOftheWeek_mapNoToDay (param i32) (result i32) (local i32)
    get_local 0
    set_local 1
    get_local 1
    i32.const 1
  ...
  (export "DaysOftheWeek_main" (func $DaysOftheWeek_main))
  (func $DaysOftheWeek_main (local i32)
    get_global 0
    i32.const 0
    i32.add
    i32.const 69
