(module 
  ...
  (func $Fibonacci_findNthFibonacciNumber (param i32) (result i32) 
    get_local 0
    i32.const 0
    i32.lt_s
    if (result i32)
      ...
      if (result i32)
        ...
        i32.const 1
        i32.sub
        call $Fibonacci_findNthFibonacciNumber
        get_local 0
        i32.const 2
        i32.sub
        call $Fibonacci_findNthFibonacciNumber
  ...
  (export "Fibonacci_main" (func $Fibonacci_main))
  (func $Fibonacci_main (local i32 i32)
    get_global 0
    i32.const 0
    i32.add
    i32.const 84
